...
- Name: tests\final-bugfix-audit.spec.js >> final bugfix audit >> TEST 6: homepage 4 collection cards are equal and have working buttons
- Location: tests\final-bugfix-audit.spec.js:193:3
