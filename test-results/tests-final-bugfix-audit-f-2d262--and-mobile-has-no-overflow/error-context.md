...
- Name: tests\final-bugfix-audit.spec.js >> final bugfix audit >> TEST 5: contact form outer box removed and mobile has no overflow
- Location: tests\final-bugfix-audit.spec.js:174:3
...
Call log:
  - navigating to "/contact.html", waiting until "load"
